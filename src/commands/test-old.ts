...
import {  FileDiagnostics, getFileDiagnostics } from "./testing/getFileDiagnostics";
import {  clearCache, initializeHasher } from "../cache/cache";
...
function setupProject(config: string) {
